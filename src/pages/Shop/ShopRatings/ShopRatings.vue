<template>
  <div class="ratings">
    <div class="ratings-content">
      ...
      <div class="selectBg">
        <SelectFilter :selectRateType="selectRateType"
...
import Star from '../../../compnents/Star/Star'
import SelectFilter from '../../../compnents/SelectFilter/SelectFilter'
...
export default {
  ...
  computed:{
    ...
    filterRatings () {
     const {selectRateType, onlyContent} = this
