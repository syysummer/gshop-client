<template>
  <div>
    <div class="shopcart">
      <div class="content">
        <div class="content-left" @click="toggleCartShow">
        ...
        <div class="content-right">
          <div class="pay" :class="(info.minPrice - cartFoodPrice) > 0 ? 'not-enough' : 'enough'">
            {{payContent}}
          </div>
        </div>
      </div>
